/* Table: Stadium
 ...
 with consecutive id's, and the number of people is
 ...
 and each of them has >= 100 people attended.
 Note that row 8 was included even though the visit_date
